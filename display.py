...
def main():
		...
		# device.letter(1, 7, hour % 10, True) # Ones
		# Set minutes
		# device.letter(1, 6, int(minute / 10)) # Tens
		# device.letter(1, 5, minute % 10) # Ones 


		# To show gravity
		device.letter(1, 4, gravity[0], True)
		device.letter(1, 3, gravity[1])
		device.letter(1, 2, gravity[2])
		device.letter(1, 1, gravity[3])
